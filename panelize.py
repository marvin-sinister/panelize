#!/usr/bin/python3
#
# This script was originaly part of Tin's Kicad Tools.
# https://projects.borg.ch/electronics/kicad/panelize.html
#
# Copyright (c) 2018 Marvin Sinister <marvin.sinister@gmail.com>
#
...
__version__ = "4.0.0"
__revision__ = "$Rev: 1 $ unkown".split()[1]
...
class Module( KicadFatObj ):
	...
	def copy( self, trans ):
		...
		for poly in self.polys:
			obj.polys.append( poly.copy( trans ) )
		return obj
...
class PcbPlotParams( KicadFatObj ):
	...
	def init_defaults( self ):
		...
		self.usegerberattributes.value = False
		self.usegerberadvancedattributes.value = False
		self.creategerberjobfile.value = False
	...
	def write( self, writer ):
		...
		self.write_objects( writer, (
			...
			"outputdirectory", "usegerberadvancedattributes", "usegerberattributes",
			"creategerberjobfile",
		) )
		# writer.newline()
		writer.end()
...
class Setup( KicadFatObj ):
	...
	def init_defaults( self ):
		...
		self.solder_mask_min_width.value = 0.0
